...
if &background == "dark"
  ...
  hi Comment      gui=italic guifg=Orange
  ...
  hi Comment      gui=italic guifg=#8b8b8b guibg=NONE
  ...
  if has("gui_macvim")
    ...
    hi Normal       gui=NONE guifg=MacTextColor guibg=#f5f5f5
  else
    hi Normal       gui=NONE guifg=Black guibg=White
  endif
  if has("gui")
    "MSV {{{
    highlight NonText guifg=#8b8b8b
    highlight SpecialKey guifg=#8b8b8b
    " }}}
  endif
